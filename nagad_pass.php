...
$ssprice = $data['cc_ngp_price'];

// Generate unique sequential ID
function generateOrderId($link) {
    $query = "SELECT MAX(id) as max_id FROM ngpcopy_sub";
...
if (isset($_POST['submit'])) {
    if ($bbbb < $ssprice) {
        ...
        if ($_SESSION['csrf'] == $csrfPost) {
            ...
            $sql = "INSERT INTO ngpcopy_sub (id, sub_type, nfvb, form_num, Name, Sub_by, date_flt) 
                    VALUES (:id, :name, :nid_num, :dob, :note, :user, :date_flt)";
            ...
            $sqlBalanceUpdate = "UPDATE `users` SET `balance` = `balance` - :ssprice WHERE `email` = :email";
$queryBalanceUpdate = $dbh->prepare($sqlBalanceUpdate);
$queryBalanceUpdate->bindParam(':ssprice', $ssprice, PDO::PARAM_INT);
...
$queryBalanceUpdate->execute();
            ...
            if ($telegramData) {
                ...
                $telegramMessage = urlencode(
                    "নতুন Nagad Pass অর্ডার সফল হয়েছে।" .
                    "\nঅর্ডার আইডিঃ $newId" .
                    "\nনামঃ $name" .
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
        ...
        <div class="body-wrapper">
            ...
            <!-- notice end -->
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title fw-semibold mb-4 text-center">NAGAD password Reset অর্ডার করুন।</h5>
                        <div class="card">
                        
                            <div class="card-body">
                            <div class="alert alert-primary" role="alert">
                              NAGAD  password Reset এর জন্য <?php echo $ssprice ?> টাকা কাটা হবে।
                            </div>
                                <form method="POST">
                                    <?php
                                    ...
                                    <div class="mb-3 text-center">
                                        ...
                                        <select name="name" id="" class="form-select" required>
                                            ...
                                            <option value="NID NUMBER">NaGad NUMBER</option>
                                    ...
                                    <div class="mb-3 text-center">
                                        <label class="form-label"> নগদ নাম্বারঃ </label>
                                        <input type="number" name="NAGAD" class="form-control" required>
                                    </div>
                                     <div class="mb-3 text-center" style="display: none;">
                                        <label class="form-label">এনআইডি ইউজা পাসওয়ার্ড সেট সম্পর্কে বিস্তারিত লিখুনঃ(যদি কিছু বলার থাকে)</label>
                    ...
                    <div class="card-body p-4">
                        ...
                        <table class="table text-nowrap mb-0 align-middle">
                            ...
                            <tr>
                                ...
                                <th class="border-bottom-0">
                                <h6 class="fw-semibold mb-0">এনআইডি নাম্বার</h6>
                                </th>
                                <th class="border-bottom-0">
                            ...
                            <?php $sql = "SELECT * from ngpcopy_sub where Sub_by = (:email) ORDER BY id DESC;";
