...
if (isset($_POST['submit'])) {
    if ($initialBalance < $ssprice) {
        ...
        $brn = mysqli_real_escape_string($link, $_POST['brn']);
        ...
        if ($_SESSION['csrf'] == $csrfPost) {
            ...
            $sql = "INSERT INTO zerocopy_sub (sub_type, nfvb, nid_num, brn, Name, Sub_by, date_flt) 
                    VALUES (:sub_type, :nfvb, :amount, :brn, :Name, :Sub_by, :date_flt)";
            ...
            $query->bindParam(':brn', $brn, PDO::PARAM_STR);
            ...
            $adminMessage = "নতুন Zero Return  অর্ডার সফল হয়েছে।\n";
            $adminMessage .= "নাম: $name\n";
            $adminMessage .= "Tin নাম্বার: $nid_num\n";
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
        ...
        <div class="body-wrapper">
            ...
            <!-- notice end -->
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title fw-semibold mb-4 text-center">Zero Return অর্ডার করুন।</h5>
                        <div class="card">
                        
                            <div class="card-body">
                            <div class="alert alert-primary" role="alert">
                               Zero Return এর জন্য <?php echo $ssprice ?> টাকা কাটা হবে।
                            </div>
                                <form method="POST">
                                    <?php
                                    ...
                                    <div class="mb-3 text-center">
                                        <label class="form-label"> টিন নাম্বারঃ *</label>
                                    ...
                                    <div class="mb-3 text-center">
                                        <label class="form-label">অর্থ বছর রিটার্ন :</label>
                                        ...
                                        <select name="amount" id="" class="form-select" required>
                    ...
                    <div class="card-body p-4">
                        ...
                        <table class="table text-nowrap mb-0 align-middle">
                            ...
                            <tr>
                                ...
                                <th class="border-bottom-0">
                                <h6 class="fw-semibold mb-0">টিন নাম্বার</h6>
                                </th>
                                <th class="border-bottom-0">
                            ...
                            <?php $sql = "SELECT * from zerocopy_sub where Sub_by = (:email) ORDER BY id DESC;";
