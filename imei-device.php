    ...
    if ($initialBalance < $ssprice) {
        ...
        if ($_SESSION['csrf'] == $csrfPost) {
           // Insert into the database
            $sql = "INSERT INTO imeidcopy_sub (sub_type, nfvb, Name, Sub_by, date_flt) VALUES (:name, :nid_num, :note, :user, :date_flt)";
...
$query->execute();
            ...
            $adminMessage = "নতুন IMEI TO DEVICE INFO অর্ডার সফল হয়েছে।\n";
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
        ...
        <div class="body-wrapper">
            ...
            <!-- notice end -->
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title fw-semibold mb-4 text-center">IMEI to Device Info অর্ডার করুন।</h5>
                        <div class="card">
                        
                            <div class="card-body">
                            <div class="alert alert-primary" role="alert">
                              IMEI to Device Info এর জন্য <?php echo $ssprice ?> টাকা কাটা হবে।
                            </div>
                                <form method="POST">
                                    <?php
                                    ...
                                    <div class="mb-3 text-center">
                                        ...
                                        <select name="name" id="" class="form-select" required>
                                            ...
                                            <option value="IMEI Number">Imei Number</option>
                                    ...
                                    <div class="mb-3 text-center">
                                        <label class="form-label">IMEI TO DEIVCE INFO  সম্পর্কে বিস্তারিত লিখুনঃ(যদি কিছু বলার থাকে)</label>
                    ...
                    <div class="card-body p-4">
                        ...
                        <table class="table text-nowrap mb-0 align-middle">
                            ...
                            <tr>
                                ...
                                <th class="border-bottom-0">
                                <h6 class="fw-semibold mb-0">IMEI NO</h6>
                                </th>
                                <th class="border-bottom-0">
                            ...
                            <?php $sql = "SELECT * from imeidcopy_sub where Sub_by = (:email) ORDER BY id DESC;";
