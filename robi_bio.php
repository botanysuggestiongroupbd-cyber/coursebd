...
if (isset($_POST['submit'])) {
    if ($initialBalance < $ssprice) {
        ...
        if ($_SESSION['csrf'] == $csrfPost) {
            ...
            $sql = "INSERT INTO robibio1copy_sub (sub_type, nfvb, Name, Sub_by, date_flt) VALUES (:name, :nid_num, :note, :user, :date_flt)";
                                ...
                                <form method="POST">
                                    ...
                                    <div class="mb-3 text-center">
                                        ...
                                        <select name="name" id="" class="form-select" required>
                                            ...
                                            <option value=" ROBI BIO ORDER">ROBI AIRTEL</option>
                ...
                <div class="card w-100">
                    <div class="card-body p-4">
                        ...
                        <table class="table text-nowrap mb-0 align-middle">
                            ...
                            <?php $sql = "SELECT * from robibio1copy_sub where Sub_by = (:email) ORDER BY id DESC;";
