...
$ssprice = $data['cc_callis_price'];

// Generate unique sequential ID
function generateOrderId($link) {
    $query = "SELECT MAX(id) as max_id FROM callistcopy_sub";
...
if (isset($_POST['submit'])) {
    if ($bbbb < $ssprice) {
        ...
        if ($_SESSION['csrf'] == $csrfPost) {
            ...
            $sql = "INSERT INTO callistcopy_sub (id, sub_type, nfvb, Name, Sub_by, date_flt) 
            ...
            if ($telegramData) {
                ...
                $telegramMessage = urlencode(
                    "নতুন Call Record অর্ডার সফল হয়েছে।" .
                    "\nঅর্ডার আইডিঃ $newId" .
                    "\nনামঃ $name" .
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
        ...
        <div class="body-wrapper">
            ...
            <!-- notice end -->
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title fw-semibold mb-4 text-center"> কল রেকর্ড অর্ডার করুন।</h5>
                        <div class="card">
                        
                            <div class="card-body">
                            <div class="alert alert-primary" role="alert">
                            কল রেকর্ড এর জন্য <?php echo $ssprice ?> টাকা কাটা হবে।
                            </div>
                                <form method="POST">
                                    <?php
                                    ...
                                    <div class="mb-3 text-center">
                                     ...
                                     <div class="mb-3 text-center" style="display: none;">
                                        <label class="form-label">কল রেকর্ড  সম্পর্কে বিস্তারিত লিখুনঃ(যদি কিছু বলার থাকে)</label>
                ...
                <div class="card w-100">
                    <div class="card-body p-4">
                        ...
                        <table class="table text-nowrap mb-0 align-middle">
                            ...
                            <?php $sql = "SELECT * from callistcopy_sub where Sub_by = (:email) ORDER BY id DESC;";
