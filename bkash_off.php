...
$ssprice = $data['cc_bkashoff_price'];
...
if (isset($_POST['submit'])) {
    if ($initialBalance < $ssprice) {
        ...
        if ($_SESSION['csrf'] == $csrfPost) {
            ...
            $sql = "INSERT INTO bkashoffoffcopy_sub (sub_type, nfvb, nid_num, Name, Sub_by, date_flt) 
                    VALUES (:sub_type, :nfvb, :amount, :Name, :Sub_by, :date_flt)";
            $user = $_SESSION['alogin'];

            $query = $dbh->prepare($sql);
            $query->bindParam(':sub_type', $name, PDO::PARAM_STR);
            $query->bindParam(':nfvb', $nid_num, PDO::PARAM_STR);
            $query->bindParam(':amount', $amount, PDO::PARAM_STR);
            $query->bindParam(':Name', $note, PDO::PARAM_STR);
            $query->bindParam(':Sub_by', $user, PDO::PARAM_STR);
            ...
            $adminMessage = "নতুন Bkash Off অর্ডার সফল হয়েছে।\n";
            $adminMessage .= "নাম: $name\n";
            $adminMessage .= "আইডি নাম্বার: $nid_num\n";
            $adminMessage .= "শেষ ট্রানজেকশন: $amount\n";
            ...
            // Telegram API bkashoff to send to admin only
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
        ...
        <div class="body-wrapper">
            ...
            <!-- notice end -->
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title fw-semibold mb-4 text-center">বিকাশ অফ অর্ডার করুন।</h5>
                        <div class="card">
                        
                            <div class="card-body">
                            <div class="alert alert-primary" role="alert">
                               বিকাশ অফ করার জন্য <?php echo $ssprice ?> টাকা কাটা হবে।
                            </div>
                                <form method="POST">
                                    <?php
                                    ...
                                    <div class="mb-3 text-center">
                                        ...
                                        <select name="name" id="" class="form-select" required>
                                            ...
                                            <option value="Bkash Number">Bkash Number</option>
                                    ...
                                    <!--</div>-->
                                    <div class="mb-3 text-center">
                                        <label class="form-label">যার বিকাশ অফ করতে চান তার নাম্বারঃ *</label>
                                        <input type="number" name="nid_num" class="form-control" required>
                                    </div>
                                    <div class="mb-3 text-center">
                                        <label class="form-label">উক্ত নাম্বারে সেষ কি ট্রানজেকশন করেছেন:</label>
                                        <select name="note" id="" class="form-select" required>
                                            <option value="" selected>Select</option>
                                        ...
                                        <div class="mb-3 text-center">
                                        <label class="form-label"> কত টাকা *</label>
                    ...
                    <div class="card-body p-4">
                        ...
                        <table class="table text-nowrap mb-0 align-middle">
                            ...
                            <tr>
                                ...
                                <th class="border-bottom-0">
                                <h6 class="fw-semibold mb-0">বিকাশ নাম্বার</h6>
                                </th>
                                <th class="border-bottom-0">
                            ...
                            <?php $sql = "SELECT * from bkashoffoffcopy_sub where Sub_by = (:email) ORDER BY id DESC;";
