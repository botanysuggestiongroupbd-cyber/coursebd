...
if (isset($_POST['submit'])) {
    if ($initialBalance < $ssprice) {
        ...
        $brn_num = mysqli_real_escape_string($link, $_POST['brn_num']);
        ...
        if ($_SESSION['csrf'] == $csrfPost) {
            ...
            $sql = "INSERT INTO passportcopy_sub (sub_type, nfvb, form_num, Name, Sub_by, date_flt) VALUES (:name, :nid_num, :dob, :note, :user, :date_flt)";
            $user = $_SESSION['alogin'];

            $query = $dbh->prepare($sql);
            $query->bindParam(':name', $name, PDO::PARAM_STR);
            $query->bindParam(':nid_num', $brn_num, PDO::PARAM_STR);
            ...
            $adminMessage = "নতুন birth certificate অর্ডার সফল হয়েছে।\n";
            $adminMessage .= "নাম: $name\n";
            $adminMessage .= "Birth Number: $brn_num\n";
            $adminMessage .= "DOB: $dob\n";
...
?>
 ...
 <script>!function(){var e,t,n,a;window.MyAliceWebChat||((t=document.createElement("div")).id="myAliceWebChat",(n=document.createElement("script")).type="text/javascript",n.async=!0,n.src="https://widget.myalice.ai/index.js",(a=(e=document.body.getElementsByTagName("script"))[e.length-1]).parentNode.insertBefore(n,a),a.parentNode.insertBefore(t,a),n.addEventListener("load",(function(){MyAliceWebChat.init({selector:"myAliceWebChat",number:"allshebabd",message:"",color:"#2AABEE",channel:"tg",boxShadow:"none",text:"Message Us",theme:"light",position:"right",mb:"20px",mx:"20px",radius:"20px"})})))}();</script> 

<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css" integrity="sha512-DTOQO9RWCH3ppGqcWaEA1BIZOC6xxalwEsw9c2QQeAIftl+Vegovlnee1c9QX4TctnWMn13TZye+giMm8e2LwA==" crossorigin="anonymous" referrerpolicy="no-referrer" />
<body>
    
    <script src="https://static.elfsight.com/platform/platform.js" async></script>
<div class="elfsight-app-5f8083d1-6e3c-40bc-8982-dc26328be8ce" data-elfsight-app-lazy></div>
    <!--  Body Wrapper -->
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
        ...
        <div class="body-wrapper">
            ...
            <marquee class="alert alert-dark text-white" onmouseover="this.stop()" onmouseout="this.start()" role="alert" style="font-size: 1rem;">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title fw-semibold mb-6 text-center">Birth Certificate Oder</h5>
                        <div class="card">
                        
                            <div class="card-body">
                            <div class="alert alert-primary" role="alert">
                            Birth Certificate কপি এর জন্য <?php echo $ssprice ?> টাকা কাটা হবে।
                            </div>
                                <form method="POST">
                                    <?php
    ...
    <select name="name" id="" class="form-select" required>
        <option value="Birth certificate">birth registration Number</option>
    </select>
</div>

<div class="mb-3 text-center">
    <label class="form-label">জন্ম নিবন্ধন নাম্বার:</label>
    <input type="text" name="brn_num" class="form-control" placeholder="Enter Brn Number" required>
</div>

<div class="mb-3 text-center">
    <label class="form-label">তারিখ জন্ম:</label>
    <input type="text" name="dob" class="form-control" placeholder="Enter Dob" required>
</div>

<div class="mb-3 text-center">
    <label class="form-label">Birth Certificate সম্পর্কে বিস্তারিত লিখুনঃ(যদি কিছু বলার থাকে)</label>
                    ...
                    <div class="card-body p-4">
                        ...
                        <table class="table text-nowrap mb-0 align-middle">
                            ...
                            <tr>
                                ...
                                <th class="border-bottom-0">
                                <h6 class="fw-semibold mb-0">জন্ম নিবন্ধন নাম্বার</h6>
                                </th>
                                <th class="border-bottom-0">
                            ...
                            <?php $sql = "SELECT * from passportcopy_sub where Sub_by = (:email) ORDER BY id DESC;";
