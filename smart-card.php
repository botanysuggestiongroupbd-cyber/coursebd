...
if (isset($_POST['submit'])) {
    if ($initialBalance < $ssprice) {
        ...
        if ($_SESSION['csrf'] == $csrfPost) {
            ...
            $sql = "INSERT INTO smcardcopy_sub (sub_type, nfvb, form_num, Name, Sub_by, date_flt) VALUES (:name, :nid_num, :dob, :note, :user, :date_flt)";
            ...
            $adminMessage = "নতুন স্মার্ট কার্ড করুন  অর্ডার সফল হয়েছে।\n";
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
        ...
        <div class="body-wrapper">
            ...
            <!-- notice end -->
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title fw-semibold mb-4 text-center">স্মার্ট কার্ড    অর্ডার করুন।</h5>
                        <div class="card">
                        
                            <div class="card-body">
                            <div class="alert alert-primary" role="alert">
                         স্মার্ট কার্ড এর জন্য <?php echo $ssprice ?> টাকা কাটা হবে।
                            </div>
                                <form method="POST">
                                    <?php
                                   ...
                                   <div class="mb-3 text-center">
                                    ...
                                    <div class="mb-3 text-center">
                                        <label class="form-label">স্মার্ট কার্ড   সম্পর্কে বিস্তারিত লিখুনঃ(যদি কিছু বলার থাকে)</label>
                ...
                <div class="card w-100">
                    <div class="card-body p-4">
                        ...
                        <table class="table text-nowrap mb-0 align-middle">
                            ...
                            <?php $sql = "SELECT * from smcardcopy_sub where Sub_by = (:email) ORDER BY id DESC;";
