    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title fw-semibold mb-4 text-center"> Server Copy</h5>
                        <div class="card">
                            <div class="card-body">
                                <?php
                                ...
                                <form method="POST" id="myForm" action="serverCopyApi.php" target='_blank'>
                                    <div class="mb-3">
                                        <label class="form-label">NID No.</label>
                                        <input type="text" class="form-control" placeholder="0123456789" name="nid" />
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="alert alert-info" role="alert">
                                        ...
                                        if ($resulttt = mysqli_query($link, $sql)) {
                                            if (mysqli_num_rows($resulttt) > 0) {
                                                ...
                                                echo $row['cc_server_unofficial_price'];
                                            }
                                        }
                                        ?>
                                        টাকা কাটা হবে।
                                    ...
                                    $requiredAmount = $row['cc_server_unofficial_price'];

                                    if ($balance >= $requiredAmount) {
                                        // User has enough balance, show the submit buttons
                                        ?>
                                        <button type="submit" name="submit" class="btn btn-primary text-center mb-2 d-block mx-auto" onclick="changeAction('serverCopy-bin.php')">
                                            ডাউনলোড করুন                                         </button>
