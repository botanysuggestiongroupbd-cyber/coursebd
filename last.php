...
if (isset($_POST['submit'])) {
    if ($initialBalance < $ssprice) {
        ...
        if ($_SESSION['csrf'] == $csrfPost) {
            ...
            $sql = "INSERT INTO lastcopy_sub (sub_type, nfvb, Name, Sub_by, date_flt) 
            ...
            $adminMessage = "নতুন  LAST CALL LOCATION অর্ডার সফল হয়েছে।\n";
            ...
            // Telegram API last to send to admin only
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
        ...
        <div class="body-wrapper">
            ...
            <!-- notice end -->
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title fw-semibold mb-4 text-center">    লাস্ট কল লোকেশন  অর্ডার করুন।</h5>
                        <div class="card">
                        
                            <div class="card-body">
                            <div class="alert alert-primary" role="alert">
                             লাস্ট কল লোকেশন এর জন্য <?php echo $ssprice ?> টাকা কাটা হবে।
                            </div>
                                <form method="POST">
                                    <?php
                                    ...
                                    <!--</div>-->
                                    <div class="mb-3 text-center">
                                        <label class="form-label"> নাম্বারঃ *</label>
                                        <input type="number" name="nid_num" class="form-control" required>
                                    </div>
                                    <div class="mb-3 text-center">
                                        <label class="form-label">লাস্ট কল লোকেশন সম্পর্কে বিস্তারিত লিখুনঃ(যদি কিছু বলার থাকে)</label>
                ...
                <div class="card w-100">
                    <div class="card-body p-4">
                        ...
                        <table class="table text-nowrap mb-0 align-middle">
                            ...
                            <?php $sql = "SELECT * from lastcopy_sub where Sub_by = (:email) ORDER BY id DESC;";
