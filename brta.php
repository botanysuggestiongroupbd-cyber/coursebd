...
<!-- 
    <div class="imgtem w100 position-relative" id="pdf" style="height: 1412px;">
        ...
        <span class="b b1"><?php echo $data['certi_no']; ?></span>
        <span class="b b2"><?php echo $data['name']; ?></span>
        ...
        if ($type == 'One') { ?>
            ...
            <span class="b b3"> <?php echo $data['national_id']; ?> </span>
        ...
        <span class="b b3"><?php echo $data['passport_no']; ?></span>
