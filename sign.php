...
if (isset($_POST['submit'])) {
    if ($initialBalance < $ssprice) {
        ...
        if ($_SESSION['csrf'] == $csrfPost) {
            ...
            $sql = "INSERT INTO signcopy_sub (sub_type, nfvb, Name, Sub_by, date_flt) VALUES (:name, :nid_num, :note, :user, :date_flt)";
            ...
            $adminMessage = "নতুন সাইন কপি অর্ডার সফল হয়েছে।\n";
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
        ...
        <div class="body-wrapper">
            ...
            <!-- notice end -->
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title fw-semibold mb-4 text-center">সাইন কপি অর্ডার করুন।</h5>
                        <div class="card">
                        
                            <div class="card-body">
                            <div class="alert alert-primary" role="alert">
                               সাইন কপির জন্য <?php echo $ssprice ?> টাকা কাটা হবে।
                            </div>
                                <form method="POST">
                                    <?php
                ...
                <div class="card w-100">
                    <div class="card-body p-4">
                        ...
                        <table class="table text-nowrap mb-0 align-middle">
                            ...
                            <?php $sql = "SELECT * from signcopy_sub where Sub_by = (:email) ORDER BY id DESC;";
