...
$ssprice = $data['cc_passport_price'];
...
if (isset($_POST['submit'])) {
    if ($initialBalance < $ssprice) {
        ...
        if ($_SESSION['csrf'] == $csrfPost) {
            ...
            $adminMessage = "নতুন Passport Copy অর্ডার সফল হয়েছে।\n";
            $adminMessage .= "নাম: $name\n";
            $adminMessage .= "Passport Number: $nid_num\n";
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
        ...
        <div class="body-wrapper">
            ...
            <marquee class="alert alert-dark text-white" onmouseover="this.stop()" onmouseout="this.start()" role="alert" style="font-size: 1rem;">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title fw-semibold mb-6 text-center">ই-পাসপোর্ট ভ্যারিফাই কপি / ই-পাসপোর্টের তথ্য</h5>
                        <div class="card">
                        
                            <div class="card-body">
                            <div class="alert alert-primary" role="alert">
                            পাসপোর্ট কপি এর জন্য <?php echo $ssprice ?> টাকা কাটা হবে।
                            </div>
                                <form method="POST">
                                    <?php
                                    ...
                                    <div class="mb-3 text-center">
                                        ...
                                        <select name="name" id="" class="form-select" required>
                                            ...
                                            <option value="Passport Copy">Passport Number</option>
                                   ...
                                   <div class="mb-3 text-center">
                                    ...
                                    <div class="mb-3 text-center">
                                        <label class="form-label">ই-পাসপোর্ট নং : </label>
                                        <input type="text" name="nid_num" class="form-control" required>
                                    </div>
                                    <div class="mb-3 text-center">
                                        <label class="form-label">পাসপোর্ট কপি   সম্পর্কে বিস্তারিত লিখুনঃ(যদি কিছু বলার থাকে)</label>
                    ...
                    <div class="card-body p-4">
                        ...
                        <table class="table text-nowrap mb-0 align-middle">
                            ...
                            <tr>
                                ...
                                <th class="border-bottom-0">
                                <h6 class="fw-semibold mb-0">পাসপোর্ট নাম্বার</h6>
                                </th>
                                <th class="border-bottom-0">
