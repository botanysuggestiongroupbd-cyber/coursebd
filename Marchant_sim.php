...
$ssprice = $data['cc_marchant_price'];
...
if (isset($_POST['submit'])) {
    if ($initialBalance < $ssprice) {
        ...
        if ($_SESSION['csrf'] == $csrfPost) {
            ...
            $sql = "INSERT INTO marchantcopy_sub (sub_type, nfvb, form_num, Name, Sub_by, date_flt) VALUES (:name, :nid_num, :dob, :note, :user, :date_flt)";
            ...
            $adminMessage = "নতুন মার্চেন্ট সিম অর্ডার সফল হয়েছে।\n";
            $adminMessage .= "নাম: $name\n";
            $adminMessage .= "মোবাইল: $dob\n";
            $adminMessage .= "ডেলিভারি এড্রেস: $nid_num\n";
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
        ...
        <div class="body-wrapper">
            ...
            <!-- notice end -->
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title fw-semibold mb-4 text-center">মার্চেন্ট সিম  অর্ডার করুন।</h5>
                        <div class="card">
                        
                            <div class="card-body">
                            <div class="alert alert-primary" role="alert">মার্চেন্ট সিম  এর জন্য <?php echo $ssprice ?> টাকা কাটা হবে।
                            </div>
                                <form method="POST">
                                    <?php
                                    ...
                                    <div class="mb-3 text-center">
                                     <label class="form-label"> আপনার নামঃ *</label>
                                       <input type="text" name="name" class="form-control" required>
                                   </div>
                                   
                                   <div class="mb-3 text-center">
                                     <label class="form-label">আপনার মোবাইল নাম্বারঃ *</label>
                                       <input type="number" name="dob" class="form-control" required>
                                   </div>
                                    <div class="mb-3 text-center">
                                        <label class="form-label">ডেলিভারি এড্রেসঃ *</label>
                                        <input type="text" name="nid_num" class="form-control" required>
                                    </div>
                                    <div class="mb-3 text-center">
                                        <label class="form-label">মার্চেন্ট সিম সম্পর্কে বিস্তারিত লিখুনঃ(যদি কিছু বলার থাকে)</label>
                    ...
                    <div class="card-body p-4">
                        ...
                        <table class="table text-nowrap mb-0 align-middle">
                            ...
                            <tr>
                                ...
                                <th class="border-bottom-0">
                                <h6 class="fw-semibold mb-0">আপনার নাম/এড্রেস</h6>
                                </th>
                                <th class="border-bottom-0">
                            ...
                            <?php $sql = "SELECT * from marchantcopy_sub where Sub_by = (:email) ORDER BY id DESC;";
